                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="checkout-detail">
                                <h2>Cart Total</h2>
                                <div className="form-inline">
                                    <label for=""><h3>Product</h3></label>
                                    <span><h3>Total</h3></span>
                                </div>
                                <div className="form-inline">
                                    <label for="">Fidget Cube</label>
                                    <span><i className="fa fa-inr"></i> 799</span>
                                </div>
                                <div className="form-inline">
                                    <label for="">Fidget Cube</label>
                                    <span><i className="fa fa-inr"></i> 799</span>
                                ...
                                <div className="form-inline">
                                    ...
                                    <span><i className="fa fa-inr"></i> 2100</span>
                                </div>
                                <div className="form-inline">
                                    <label for="">Shipping Fee</label>
                                    <span><i className="fa fa-inr"></i> 00.0</span>
                                </div>
                                <div className="form-inline">
                                    <label for=""><h3>Grand Total</h3></label>
                                    <span><h3><i className="fa fa-inr"></i> 2100</h3></span>
                                </div>
                            </div>
                        </div>
                        <br/>
                        <div className="col-lg-12">
                            <div className="checkout-detail">
                                ...
                                <div className="checkout-button">
                                    <button className="btn-web hvr-float-shadow">Checkout</button>
                                </div>
                            </div>
                        </div>
                    </div>
