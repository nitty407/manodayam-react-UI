        ...
        <div className="container">
            ...
            <div className="col-lg-12">
                ...
                <div className="video-question">
                        <ul>
                            <li><button className="btn spr-btn">Social Gathering?</button></li>
                            <li><button className="btn spr-btn">Having a problem related to study/job?</button></li>
                            <li><button className="btn spr-btn">Drugs</button></li>
                            <li><button className="btn spr-btn">Fear of something</button></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="related-video-heading">
                                    ...
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum mollitia non officiis, ea deserunt saepe!</p>
                                </div>
                            </div>
