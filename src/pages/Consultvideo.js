                ...
                <div className="col-lg-12">
                                ...
                                <div className="video-screens">
                                   <div className="row">
                                    <div className="col-lg-6 col-sm-6">
                                        <iframe width="300" height="315" src="https://www.youtube.com/embed/FmsWxnxHW_o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                       </div>
                                       <div className="col-lg-6 col-sm-6">
                                        <iframe width="300" height="315" src="https://www.youtube.com/embed/FmsWxnxHW_o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                       </div>
                    ...
                    <div className="col-lg-12 p-none">
                        <div className="footer-bottom">
                            <ul>
                                <li><i className="fa fa-microphone" aria-hidden="true"></i>
                                    <h4>Mute</h4>
                                </li>
                                <li><i className="fa fa-video-camera" aria-hidden="true"></i>
                                    <h4>Stop video</h4>
                                </li>
                                <li><i className="fa fa-shield" aria-hidden="true"></i>
                                    <h4>Security</h4>
                                </li>
                                <li><i className="fa fa-user-plus" aria-hidden="true"></i>
                                    <h4>Participants</h4>
                                </li>
                             
                                <li className="leave-btn"><button className="btn btn-danger"><i className="fa fa-phone" aria-hidden="true"></i></button></li>
                            </ul>
                        </div>
                    </div>
                </div>
